...
function ServiceListing() {
  ...
  */
  ...
  // Add this function for floating nested dropdowns
  ...
  const accordionStyles = `
    ...
    /* Solid Semi-Transparent Container */
    .glass-container {
    ...
    /* Solid Semi-Transparent Buttons */
    .glass-btn {
      background: rgba(255, 255, 255, 0.95) !important;
      backdrop-filter: none !important;
      -webkit-backdrop-filter: none !important;
    ...
    /* Solid Semi-Transparent Dropdown */
    .glass-dropdown {
  ...
  const FloatingFilters = () => {
    ...
    const [categoriesWidth, setCategoriesWidth] = useState(200);
    const [distanceWidth, setDistanceWidth] = useState(180);

    // Measure button widths whenever dropdowns are about to open
    const measureButtonWidths = () => {
      if (categoriesBtnRef.current) {
        setCategoriesWidth(categoriesBtnRef.current.offsetWidth);
      }
      if (distanceBtnRef.current) {
        setDistanceWidth(distanceBtnRef.current.offsetWidth);
      }
    };

    // Enhanced click handlers that measure before opening
