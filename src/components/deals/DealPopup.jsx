...
const DealPopup = ({ isOpen, onClose, dealID, serviceID, providerID }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const param = {
        ...
        phone: `${formData.stdCode}${formData.phoneNumber}`,
  ...
  return (
    <div className="fixed inset-0 mt-[70px] bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div
        ...
        className="relative flex flex-col items-center w-[361px] md:w-[550px] p-[31px] md:px-[16px] md:p-[31px] rounded-[20px] border-2 border-[#7E7E7E] md:border-[#FECD8C] bg-[#FBFBFB] shadow-[-3px_0px_23.6px_0px_rgba(0,0,0,0.25)]"
      >
        {/* Close Button */}
        <button
          type="button"
