...
import morselvlogo from "../assets/Group 1000001876.svg";
...
const Header = () => {
  ...
  const [suggestions, setSuggestions] = useState([]); // confirmed location
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-[#121212] z-50 shadow-md backdrop-blur-[20px]">
      {/* Desktop Header */}
      <div className="hidden lg:flex items-center justify-between w-full h-[90px] px-8">
        {/* Logo */}
        <div className="flex items-center gap-2">
          ...
          <Link to="/">
            <img src={morselvlogo} alt="Mor-Selv" className="text-[#FECD8C] font-montserrat text-[18px] font-medium" />
          </Link>
              ...
              >
                {categories.map((category, index) => (
                  <React.Fragment key={category.name}>
                    <div
                      className={`flex items-center justify-between cursor-pointer px-3 py-2 rounded-md select-none ${openNested.includes(index)
                    ...
                    <div
                      className={`overflow-hidden transition-[max-height,opacity,padding] duration-500 ease-in-out ${openNested.includes(index)
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          ...
          <div className="flex items-center gap-1">
            <input
              ...
              className="flex-grow outline-none text-white placeholder:text-white bg-transparent text-xs sm:text-base"
            />
            {showLocDropdown && (
      ...
      {/* Mobile Header */}
      <div className="lg:hidden flex items-center justify-between w-full h-[70px] px-4">
        <div
        ...
        >
          ...
          <img 
           src={morselvlogo} 
           alt="Mor-Selv Logo" 
           className="w-[60.309px] h-[91.865px]" />
        </div>
      ...
      {menuMounted && (
        <div
          ref={menuRef}
          className="lg:hidden fixed top-[70px] left-0 bg-white px-4 py-3 space-y-2 z-50 shadow-lg"
          style={{
            width: "100vw",
            maxWidth: 280,
              ...
              <div className="flex items-center gap-2 cursor-pointer py-2 hover:text-gray-700">
                ...
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className="flex-grow outline-none text-black placeholder:text-black bg-transparent text-xs sm:text-base"
                  />
                  {showLocDropdown && (
                    <div className="absolute top-11 left-0 sm:ml-0
             sm:bg-white bg-gray-50 shadow-md rounded-[20px] w-full sm:w-52  p-3 z-[1001] mt-2 before:content-[''] before:absolute before:-top-2 before:left-4 
              ...
              <div>
                {categories.map((category, index) => (
                  <div key={category.name} className="mb-2">
                    ...
                    {/* Subcategories */}
                    <div
                      className={`overflow-hidden transition-[max-height,opacity,padding] duration-300 ease-in-out px-4 ${mobileOpenNested.includes(index)
