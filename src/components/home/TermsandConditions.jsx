...
function TermsAndConditions() {
  return (
    <div className="w-full min-h-screen bg-white flex flex-col mt-[70px] md:mt-[90px]">
      {/* Top Gradient Box */}
      <div className="w-full bg-gradient-to-b from-[#FECD8C66] to-transparent flex flex-col justify-center items-center text-center px-4">
        <h2 className="text-[#FECD8C] font-montserrat text-2xl font-600 font-normal leading-[125%] mt-[108px]">
          TERMS & CONDITIONS
        </h2>
        <h1 className="text-[#000] font-inter text-5xl md:text-6xl font-600 leading-[125%] mt-4">
      ...
      <div className="w-full flex-1 px-4 flex flex-col items-center pb-20">
        <div className="w-full max-w-[1280px] space-y-8 text-left">
          ...
          {/* Section 1 */}
          <div>
            <h3 className="text-[#5D5D5D] font-montserrat text-20px font-normal font-600 leading-[125%]">
          ...
          {/* Section 3 */}
          <div>
            <h3 className="text-[#5D5D5D] font-montserrat text-[20px] font-normal font-600 leading-[125%] pb-6">
          ...
          <div>
            ...
            <ul className="list-disc mt-2 text-[#5D5D5D] font-montserrat text-[16px] font-normal font-500 leading-[150%]">
          ...
          <div>
            ...
            <p className="text-[#5D5D5D] font-montserrat text-[16px] font-normal font-500 leading-[125%] mt-2">
          ...
          <div>
            ...
            <div className="mt-2 text-[#5D5D5D] font-montserrat text-[16px] font-normal font-500 leading-[150%]">
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>
                  <span className="font-normal font-600">Email:</span> info@morselv.com
                </li>
                <li>
                  <span className="font-normal font-600">Phone:</span> +91-9818257300
                </li>
                <li>
                  <span className="font-normal font-600">Address:</span> FEMTECH SPHERE
